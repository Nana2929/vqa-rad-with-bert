...
_C.DATASET.EMBEDDER_MODEL = ""
_C.DATASET.FIX_EMB_MODEL=True
_C.DATASET.EMB_DIM=768
_C.DATASET.DATA_DIR = ""
...
# ----- OPTIMIZER -----
_C.TRAIN.BAN_OPTIMIZER = CN()
_C.TRAIN.BAN_OPTIMIZER.TYPE = "SGD"
_C.TRAIN.BAN_OPTIMIZER.BASE_LR = 0.1
_C.TRAIN.BAN_OPTIMIZER.MOMENTUM_CNN = 0.9
_C.TRAIN.BAN_OPTIMIZER.EPS_CNN = 0.9
_C.TRAIN.BAN_OPTIMIZER.WEIGHT_DECAY = 4e-4

_C.TRAIN.BERT_OPTIMIZER = CN()
_C.TRAIN.BERT_OPTIMIZER.TYPE = "ADAM"
_C.TRAIN.BERT_OPTIMIZER.BASE_LR = 1e-5
...
_C.TRAIN.ATTENTION.USE_ORIGINAL_TYPEATT = False 
